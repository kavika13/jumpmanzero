...
local function DrawHorizontal_()
    ...
    transform_set_scale(g_transform_index, iLen, 1, 3);
    transform_set_rotation_z(g_transform_index, g_current_rotation_z);
    ...
    if g_wobble_animation_counter > 2 then
        transform_set_translation(g_transform_index, (g_current_pos_x[1] + g_current_pos_x[2]) / 2, (g_current_pos_y[1] + g_current_pos_y[2]) / 2 + 0.04, 5);
    else
        transform_set_translation(g_transform_index, (g_current_pos_x[1] + g_current_pos_x[2]) / 2, (g_current_pos_y[1] + g_current_pos_y[2]) / 2 - 0.04, 5);
    end
end
...
local function DrawVertical_()
    ...
    transform_set_scale(g_transform_index, g_current_pos_y[1] - g_current_pos_y[2], 1.3, 3);
    transform_set_rotation_z(g_transform_index, 90);
    transform_set_translation(g_transform_index, g_current_pos_x[1] + 0.3, (g_current_pos_y[1] + g_current_pos_y[2]) / 2, 5);
end
