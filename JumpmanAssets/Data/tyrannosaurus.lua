...
function Module.update()
    ...
    scale_mesh_matrix(g_animation_mesh_indices[g_animation_current_frame], 2, 2, 1.5);
    script_selected_mesh_translate_matrix(g_current_pos_x, g_current_pos_y + 19, 3);
