...
local level_level20_module = assert(loadfile("Data/level_level20.lua"));
...
function initialize(game_input)
    ...
    g_game_logic.LevelData = level_level20_module();
...
function reset()
    ...
    g_game_logic.set_player_current_position_y(94);
