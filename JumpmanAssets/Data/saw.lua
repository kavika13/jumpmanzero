...
function Module.update()
  ...
  elseif (g_current_direction == 4 and g_current_time_in_air == 0) or (g_current_direction == 3 and g_current_time_in_air ~= 0) then
    g_current_rotation_z_degrees = g_current_rotation_z_degrees - 6;
  else
    g_current_rotation_z_degrees = g_current_rotation_z_degrees + 6;
  end
  ...
  if is_player_colliding_with_rect(g_current_pos_x - 3, g_current_pos_y + 1, g_current_pos_x + 3, g_current_pos_y + 3.5) then
    kill();
  end
end
