...
OBJECTS = $(ENGINE_LIB_OBJECTS) $(ENGINE_LIB_OBJECTS) $(GAME_BIN_OBJECTS) $(ENGINE_LIB_TEST_BIN_OBJECTS) $(LEVELCONVERTER_BIN_OBJECTS)
...
LEVELCONVERTER_BIN_CPPFLAGS = -I$(SOURCE_DIR) -I$(SYSTEM_INCLUDE_DIR)
LEVELCONVERTER_BIN_LDLIBS = -l$(ENGINE_LIB)
...
release: $(BUILD_DIR)/release/$(ENGINE_LIB_BIN) $(BUILD_DIR)/release/$(GAME_BIN) $(BUILD_DIR)/release/$(ENGINE_LIB_TEST_BIN) $(BUILD_DIR)/release/$(LEVELCONVERTER_BIN)
# Mac specific
release: $(BUILD_DIR)/release/$(GAME_APP)
debug: $(BUILD_DIR)/debug/$(ENGINE_LIB_BIN) $(BUILD_DIR)/debug/$(GAME_BIN) $(BUILD_DIR)/debug/$(ENGINE_LIB_TEST_BIN) $(BUILD_DIR)/debug/$(LEVELCONVERTER_BIN)
# Mac specific
