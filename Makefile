...
ENGINE_INCLUDE_DIR = $(SOURCE_DIR)/$(ENGINE_LIB_SOURCE_DIR)
...
OBJECTS = $(ENGINE_LIB_OBJECTS) $(ENGINE_LIB_OBJECTS) $(GAME_BIN_OBJECTS) $(ENGINE_LIB_TEST_BIN_OBJECTS)
...
ENGINE_LIB_CPPFLAGS = -I$(ENGINE_INCLUDE_DIR) -I$(GLM_INCLUDE_DIR) -I$(LUA_INCLUDE_DIR) -I$(FMOD_INCLUDE_DIR) -I$(BOOST_INCLUDE_DIR) -I$(SYSTEM_INCLUDE_DIR)
ENGINE_LIB_LDFLAGS = -dynamiclib -install_name '@rpath/$(ENGINE_LIB_BIN)' -current_version $(ENGINE_LIB_VERSION) -L$(LUA_LIB_DIR) -L$(FMOD_LIB_DIR) -L$(SYSTEM_LIB_DIR)
ENGINE_LIB_LDLIBS = -l$(LUA_LIB) -l$(FMOD_LIB) -l$(BOOST_SYSTEM_LIB) -l$(BOOST_FILESYSTEM_LIB) -l$(BOOST_LOG_LIB) -l$(BOOST_THREAD_LIB)
GAME_BIN_CPPFLAGS = -I$(ENGINE_INCLUDE_DIR) -I$(SYSTEM_INCLUDE_DIR)
GAME_BIN_LDLIBS = -l$(ENGINE_LIB)
ENGINE_LIB_TEST_BIN_LDLIBS = -l$(ENGINE_LIB)

# Mac specific
DYNAMIC_LIBS = $(ENGINE_LIB_BIN) $(SDL_FRAMEWORK_BIN) $(SDL_IMAGE_FRAMEWORK_BIN) $(FMOD_LIB_BIN)
...
release: $(BUILD_DIR)/release/$(ENGINE_LIB_BIN) $(BUILD_DIR)/release/$(GAME_BIN) $(BUILD_DIR)/release/$(ENGINE_LIB_TEST_BIN)
# Mac specific
release: $(BUILD_DIR)/release/$(GAME_APP)
debug: $(BUILD_DIR)/debug/$(ENGINE_LIB_BIN) $(BUILD_DIR)/debug/$(GAME_BIN) $(BUILD_DIR)/debug/$(ENGINE_LIB_TEST_BIN)
# Mac specific
debug: $(BUILD_DIR)/debug/$(GAME_APP)

$(BUILD_DIR)/release:
	mkdir -p $(addprefix $(BUILD_DIR)/release/, . $(OBJECT_DIRS))

$(BUILD_DIR)/debug:
	mkdir -p $(addprefix $(BUILD_DIR)/debug/, . $(OBJECT_DIRS))

$(BUILD_DIR)/%/$(ENGINE_LIB_BIN): CPPFLAGS := $(CPPFLAGS) $(ENGINE_LIB_CPPFLAGS)
$(BUILD_DIR)/%/$(ENGINE_LIB_BIN): CXXFLAGS := $(CXXFLAGS) $(ENGINE_LIB_CXXFLAGS)
$(BUILD_DIR)/%/$(ENGINE_LIB_BIN): LDFLAGS := $(LDFLAGS) $(ENGINE_LIB_LDFLAGS)
$(BUILD_DIR)/%/$(ENGINE_LIB_BIN): LDLIBS := $(LDLIBS) $(ENGINE_LIB_LDLIBS)
$(BUILD_DIR)/%/$(ENGINE_LIB_BIN): $(addprefix $(BUILD_DIR)/%/, $(ENGINE_LIB_OBJECTS)) | $(BUILD_DIR)/%
	$(LINK.cpp) $^ $(LOADLIBES) $(LDLIBS) -o $@

$(BUILD_DIR)/%/$(GAME_BIN): CPPFLAGS := $(CPPFLAGS) $(GAME_BIN_CPPFLAGS)
$(BUILD_DIR)/%/$(GAME_BIN): CXXFLAGS := $(CXXFLAGS) $(GAME_BIN_CXXFLAGS)
$(BUILD_DIR)/%/$(GAME_BIN): LDFLAGS := $(LDFLAGS) $(GAME_BIN_LDFLAGS)
$(BUILD_DIR)/%/$(GAME_BIN): LDLIBS := $(LDLIBS) $(GAME_BIN_LDLIBS)
$(BUILD_DIR)/%/$(GAME_BIN): $(addprefix $(BUILD_DIR)/%/, $(GAME_BIN_OBJECTS)) | $(BUILD_DIR)/% $(BUILD_DIR)/%/$(ENGINE_LIB_BIN) $(addprefix $(BUILD_DIR)/%/, $(DYNAMIC_LIBS))
	$(LINK.cpp) -L$(BUILD_DIR)/$* $^ $(LOADLIBES) $(LDLIBS) -o $@

$(BUILD_DIR)/%/$(ENGINE_LIB_TEST_BIN): CPPFLAGS := $(CPPFLAGS) $(ENGINE_LIB_TEST_BIN_CPPFLAGS)
$(BUILD_DIR)/%/$(ENGINE_LIB_TEST_BIN): CXXFLAGS := $(CXXFLAGS) $(ENGINE_LIB_TEST_BIN_CXXFLAGS)
$(BUILD_DIR)/%/$(ENGINE_LIB_TEST_BIN): LDFLAGS := $(LDFLAGS) $(ENGINE_LIB_TEST_BIN_LDFLAGS)
$(BUILD_DIR)/%/$(ENGINE_LIB_TEST_BIN): LDLIBS := $(LDLIBS) $(ENGINE_LIB_TEST_BIN_LDLIBS)
...
# Mac specific
$(BUILD_DIR)/release/$(GAME_APP)/Contents/Resources/%: $(GAME_DATA_DIR)/%
	cp $< $@

# Mac specific
$(BUILD_DIR)/debug/$(GAME_APP)/Contents/Resources/%: $(GAME_DATA_DIR)/%
	cp $< $@
