...
ENGINE_LIB_CPP_SOURCES = $(wildcard $(SOURCE_DIR)/$(ENGINE_LIB_SOURCE_DIR)/*.cpp) $(wildcard $(SOURCE_DIR)/$(ENGINE_LIB_OBJECTS_SOURCE_DIR)/*.cpp) $(wildcard $(SOURCE_DIR)/$(ENGINE_LIB_GRAPHICS_SOURCE_DIR)/*.cpp)
