...
ENGINE_LIB_CPPFLAGS = -I$(ENGINE_INCLUDE_DIR) -I$(GLM_INCLUDE_DIR) -I$(LUA_INCLUDE_DIR) -I$(FMOD_INCLUDE_DIR) -I$(JSONCPP_INCLUDE_DIR) -I$(BOOST_INCLUDE_DIR) -I$(SYSTEM_INCLUDE_DIR)
