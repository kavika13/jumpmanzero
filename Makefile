...
ENGINE_LIB_CPPFLAGS = -I$(SOURCE_DIR) -I$(GLM_INCLUDE_DIR) -I$(LUA_INCLUDE_DIR) -I$(FMOD_INCLUDE_DIR) -I$(JSONCPP_INCLUDE_DIR) -I$(TINY_OBJ_LOADER_INCLUDE_DIR) -I$(BOOST_INCLUDE_DIR) -I$(SYSTEM_INCLUDE_DIR)
